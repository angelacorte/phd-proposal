...
in which I will work on a project that involves the development of a system for managing the communication between maritime autonomous
surface ships in the Kiel Canal, using the \ac{ac} paradigm.

The work done has allowed me to submit a paper to the \emph{IEEE International Conference on Autonomic Computing and Self-Organizing Systems} (ACSOS 2024),
...
%
Another paper is currently under review to the \emph{International Symposium on Distributed Simulation and Real Time Applications} (DS-RT 2024).
%
...
there are more types of users: the people that are part of the crowd and the law enforcement that can manage the crowd.
%
Clearly,
...
The necessity of sending signals to processes while they are running,
...
and send data to the system to manage the crowd.
%
...
%
There also may be the need of the intervention of the law enforcement to manage the crowd (users and permissions),
...
involves communication between maritime autonomous surface ships in the Kiel Canal. %and the amount of data that they can exchange
%depending on the different technology of communication they are using.
%
Ships use different technologies to communicate with each others,
...
in order to avoid light pollution and save energy,
...
eventually in a real-world environmenty with the help of a partnership where appropriate hardware is available.
%
Therefore,
...
particularly prof. Sven Tomforde, who has expressed interest in collaborating.
%
Additionally,
I hope to discuss potential collaborations soon with a network of experts who have participated in the previously mentioned conferences,
such as prof. Lukas Esterle and prof. Alessandro Papadopoulos,
whom already have worked with our research group.
