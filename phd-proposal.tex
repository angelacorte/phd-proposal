...
In the second year,
the goal is to expand the functionalities of the system to manage multi-user, rights and permissions, and aggregate peripherals devices.

\paragraph{Third year}
In the third and final year,
the goal is to use the final prototype of the system in simulated real-world scenarios and to evaluate its performance and effectiveness.
