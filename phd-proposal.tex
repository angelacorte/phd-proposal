...
In the second year,
it is expected to develop a prototype of the system and to test it in a controlled environment.

\paragraph{Third year}
In the third and final year,
the goal is to use the system in real-world scenarios and to evaluate its performance and effectiveness.
