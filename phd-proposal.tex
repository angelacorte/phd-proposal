...
\angela{sisop distribuito, far capire in che modo il mio è diverso e non esiste}
...
\begin{inlinelist}
    ...
    \item a theoretical and executable model of the collective operating system,
...
\angela{international collaborations, uno dei modi che usero per valutare è quella di inserirmi con successo in reti di collaborazione
ne sono gia state identificate alcune, in particolare ho gia parlato con tomforde
e ho una rete di esperti che so che partecipa nelle conf precedenti con i quali mi auspico di aver presto un
confronto per collaborazioni (lukas, papadopulos)}
