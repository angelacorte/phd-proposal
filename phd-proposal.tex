...
\end{itemize}
\angela{signals?}
\angela{what does it mean 'user' in an aggregate environment?}
...
%The project will focus on the development of a new generation of operative systems that can be used in the context of \ac{cas},
%where the coordination of devices is challenging due to the heterogeneity of the devices involved,
%resource constraints, and the need to adapt to dynamic changes in the environment.
