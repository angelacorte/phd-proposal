...
\begin{figure}
    ...
    \caption{
        Aggregate processes executing on a collective operating system.
...
\sloppypar
\paragraph{Research goals and challenges}
...
sadawsdas
%
term per spegnere in modo ordinato o un kill
%
chi può farlo? si relaziona alle cose sopra

comunicazione tra processi
%
crowd steering vs. tracking

sensori e attuatori distribuiti

Realising as similar system requires an understanding of the meaning of users, groups, and permissions when
these concepts are tight to space and time.
%
...
%
Moreover, interprocess communication,
...
\sloppypar
\paragraph{Unire con quello prima}
%
...
realizing a form of ``sensor fusion''~\cite{TODO} at the application level.
