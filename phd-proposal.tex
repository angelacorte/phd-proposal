...
\sloppypar{\textbf{Collective Adaptive Systems and Macroprogramming}}
...
\sloppypar{\textbf{Self-organization and Field Calculus}}
...
\sloppypar{\textbf{Aggregate Computing/Programming}}
...
%
The fundamental computation unit shifts from a single device to an ensemble of devices.

\ac{ac} composes collective behaviors to achieve effective and resilient complex behaviors in dynamic networks,
viewing the environment as a whole programmable entity
where parts collaborate to produce and consume services across space and time.
%
...
\begin{inlinelist}
    ...
    \item \emph{behavior compositionality},
    describing rich collective services through the functional composition of simpler services,
    \item \emph{abstraction}, enabling adaptivity by abstracting from low-level details.
\end{inlinelist}
%
These attributes are crucial in both the design phase,
...
\sloppypar{\textbf{Actual tools for Aggregate Computing}}
