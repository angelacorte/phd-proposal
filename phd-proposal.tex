...
in which I will work on a project that involves the development of a system for managing the communication between ships in the Kiel Canal,
...
different technology of communication they are using.
%
Specifically,
the farther apart the ships are,
the fewer data they can exchange due to the technology of communication available;
for instance,
the ships in a certain range typically communicate through 5G and can exchange more data between them,
...
\angela{Add sven's and rewrite light scenario}
...
\begin{inlinelist}
    ...
    \item a prototype of the system that is able to manage problems that can arise in a collective environment, such as the scenarios mentioned in \Cref{subsec:example-applications}.
\end{inlinelist}
%%
%For instance,
%one of the problems presented in the aforementioned collaboration with prof. Sven Tomforde,
