...
each node has \emph{part} of the distributed resources and has to manage \emph{different processes} from other nodes,
...
with the aim of evaluating the processes as a collective.
